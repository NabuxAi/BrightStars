...
function bs_i18n_dict() {
	...
	$dict = array(
		'en' => array(
			...
			// Hero.
			'hero.tag' => 'Digital marketing · Oman', 'hero.h1a' => 'Lighting the path', 'hero.h1b' => 'for your', 'hero.brand' => 'brand.', 'hero.sub' => 'Bright Stars is a Muscat-based digital marketing agency for ambitious brands — we partner with you from growth to business development, and from the bright idea all the way to execution.', 'hero.start' => 'Start a project', 'hero.what' => 'What we do',
			...
			// Blog.
			'bl.eyebrow' => 'From the studio', 'bl.h' => 'Insights & stories', 'bl.h2' => 'The Bright Stars blog', 'bl.sub' => 'Playbooks, production notes and growth stories from taking brands from zero to viral.', 'bl.read' => 'Read article', 'bl.all' => 'Read the blog',
			// Clients.
			...
			// About.
			'ab.eyebrow' => 'About us', 'ab.h' => 'The team behind Bright Stars', 'ab.intro' => 'Bright Stars is a Muscat-based digital marketing agency helping ambitious brands grow — from strategy to execution. We are a small senior team that treats your brand like our own, combining sharp marketing with high-craft content and design.',
			...
			// Testimonials.
			'ts.eyebrow' => 'Client voices', 'ts1q' => 'Bright Stars feels like our in-house team — senior, fast, and genuinely invested in the numbers.', 'ts1r' => 'CMO, Oasis Living', 'ts2q' => 'From idea to launch in six weeks. The strategy was sharp and the execution flawless.', 'ts2r' => 'Founder, Mizan Pay',
			// Pricing.
			...
			// Footer.
			'ft.tag' => '< Lighting the path for your brand >', 'ft.services' => 'Services', 'ft.agency' => 'Agency', 'ft.contact' => 'Contact', 'ft.work' => 'Clients', 'ft.copy' => '© 2026 Bright Stars · Muscat, Oman', 'ft.legal' => 'Terms · Privacy',
			// Generic UI.
			...
			// Client case study.
			'cl.work_e' => 'Selected work', 'cl.work_h' => 'The feed we built', 'cl.work_sub' => 'Scroll through the real profiles — content, art direction and grids by Bright Stars.',
		...
		'ar' => array(
			...
			'hero.tag' => 'تسويق رقمي · عُمان', 'hero.h1a' => 'نُنير الطريق', 'hero.h1b' => 'لعلامتك', 'hero.brand' => 'التجارية.', 'hero.sub' => 'برايت ستارز وكالة تسويق رقمي مقرّها مسقط للعلامات الطموحة — نرافقك من النمو إلى تطوير الأعمال، ومن الفكرة المضيئة حتى التنفيذ.', 'hero.what' => 'ماذا نقدّم',
			...
			'bl.eyebrow' => 'من الاستوديو', 'bl.h' => 'رؤى وقصص', 'bl.h2' => 'مدوّنة برايت ستارز', 'bl.sub' => 'أدلة عملية وملاحظات إنتاج وقصص نمو من رحلة العلامات من الصفر إلى الانتشار.', 'bl.read' => 'اقرأ المقال', 'bl.all' => 'تصفّح المدوّنة',
			...
			'ab.eyebrow' => 'من نحن', 'ab.h' => 'الفريق وراء برايت ستارز', 'ab.intro' => 'برايت ستارز وكالة تسويق رقمي مقرّها مسقط تساعد العلامات الطموحة على النمو — من الاستراتيجية إلى التنفيذ. نحن فريق صغير محترف يتعامل مع علامتك كأنها علامته، نجمع بين تسويق ذكي ومحتوى وتصميم عالي الإتقان.',
			...
			'ts.eyebrow' => 'آراء العملاء', 'ts1q' => 'برايت ستارز كأنه فريقنا الداخلي — محترف وسريع ومهتم فعلاً بالأرقام.', 'ts1r' => 'مديرة التسويق، أوازيس ليفينغ', 'ts2q' => 'من الفكرة إلى الإطلاق في ستة أسابيع. استراتيجية ذكية وتنفيذ بلا أخطاء.', 'ts2r' => 'المؤسس، ميزان باي',
			...
			'ft.tag' => '< نُنير الطريق لعلامتك التجارية >', 'ft.services' => 'خدماتنا', 'ft.agency' => 'الوكالة', 'ft.contact' => 'تواصل', 'ft.work' => 'عملاؤنا', 'ft.copy' => '© 2026 برايت ستارز · مسقط، عُمان', 'ft.legal' => 'الشروط · الخصوصية',
			'ui.menu' => 'القائمة', 'ui.close' => 'إغلاق', 'ui.readmore' => 'اقرأ المزيد', 'ui.back' => 'رجوع', 'ui.allposts' => 'كل المقالات', 'ui.search' => 'بحث', 'ui.lang' => 'اللغة',
			'cl.work_e' => 'أعمال مختارة', 'cl.work_h' => 'الحساب الذي بنيناه', 'cl.work_sub' => 'تصفّح الحسابات الحقيقية — المحتوى والإخراج الفني والشبكة من برايت ستارز.',
		...
		'fa' => array(
			...
			'hero.tag' => 'بازاریابی دیجیتال · عمان', 'hero.h1a' => 'روشن‌کردن مسیر', 'hero.h1b' => 'برای برند', 'hero.brand' => 'شما.', 'hero.sub' => 'برایت استارز یک آژانس بازاریابی دیجیتال در مسقط برای برندهای جاه‌طلب است — از رشد تا توسعهٔ کسب‌وکار و از ایدهٔ درخشان تا اجرا همراه شماییم.', 'hero.what' => 'چه می‌کنیم', 'hero.start' => 'شروع پروژه',
			...
			'bl.eyebrow' => 'از استودیو', 'bl.h' => 'بینش‌ها و داستان‌ها', 'bl.h2' => 'وبلاگ برایت استارز', 'bl.sub' => 'راهنماها، یادداشت‌های تولید و داستان‌های رشد از مسیر برندها از صفر تا وایرال.', 'bl.read' => 'خواندن مقاله', 'bl.all' => 'مشاهدهٔ وبلاگ',
			...
			'ts.eyebrow' => 'صدای مشتریان', 'ts1q' => 'برایت استارز مثل تیم داخلی ماست — حرفه‌ای، سریع و واقعاً درگیر اعداد.', 'ts1r' => 'مدیر بازاریابی، اوازیس لیوینگ', 'ts2q' => 'از ایده تا اجرا در شش هفته. استراتژی دقیق و اجرای بی‌نقص.', 'ts2r' => 'بنیان‌گذار، میزان پی',
			...
			'ft.tag' => '< روشن‌کردن مسیر برای برند شما >', 'ft.services' => 'خدمات', 'ft.agency' => 'آژانس', 'ft.contact' => 'تماس', 'ft.work' => 'مشتریان', 'ft.copy' => '© ۲۰۲۶ برایت استارز · مسقط، عمان', 'ft.legal' => 'قوانین · حریم خصوصی',
			'ui.menu' => 'منو', 'ui.close' => 'بستن', 'ui.readmore' => 'بیشتر بخوانید', 'ui.back' => 'بازگشت', 'ui.allposts' => 'همهٔ مقالات', 'ui.search' => 'جستجو', 'ui.lang' => 'زبان',
			'cl.work_e' => 'کارهای منتخب', 'cl.work_h' => 'حسابی که ساختیم', 'cl.work_sub' => 'در حساب‌های واقعی پیمایش کنید — محتوا، مدیریت هنری و شبکه از برایت استارز.',
